...
async def rename(bot, update):
    ...
    await update.message.delete()
    await update.message.reply_text(f"<i>Please Enter The New Filename...</i>\n\n<b>Note :</b> Extension Not Required", reply_to_message_id=id,
...
async def vid(bot, update):
    ...
    if value < file.file_size:
        ...
        c_time = time.time()
        try:
            naruto = await bot.send_video(update.from_user.id, video=file_path, thumb=ph_path, duration=duration, caption=caption, progress=progress_for_pyrogram, progress_args=("🚀 Try To Uploading...  ⚡",  ms, c_time))
...
async def aud(bot, update):
    ...
    if thumb:
        ...
        c_time = time.time()
        try:
            naruto = await bot.send_audio(update.message.chat.id, audio=file_path, caption=caption, thumb=ph_path, duration=duration, progress=progress_for_pyrogram, progress_args=("🚀 Try To Uploading...  ⚡",  ms, c_time))
        ...
        c_time = time.time()
        try:
            naruto = await bot.send_audio(update.message.chat.id, audio=file_path, caption=caption, duration=duration, progress=progress_for_pyrogram, progress_args=("🚀 Try To Uploading...  ⚡",  ms, c_time))
